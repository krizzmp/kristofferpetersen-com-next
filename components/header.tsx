...
export function Header () {
  return <div className={c.header}>
    {/*<img src={"/static/logo_v3.1.png"} alt={"kmp"}/>*/}
    <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px"
         viewBox="0 0 796.2 395.1"  height={32}>
      <g id="XMLID_209_">
        <path id="XMLID_81_" d="M261,0.1h123l0.5-0.1c-1.1,75.1-32.3,143.5-84.8,189.6c53.5,46.9,89.6,117.2,89.6,193.9c0,1,0,7.6,0,11.6
      ...
      <g id="XMLID_210_">
        <path id="XMLID_79_" d="M539.2,128.7c69.7,0,128.2-62.6,129.2-128.6h127.9c-1.7,135-117.1,254-257.1,254l-5.8-0.4l0,141.4H406V0.1
		h127.2l0.1,128.7L539.2,128.7z"/>
      </g>
    </svg>
    <div className={c.content}>
      <div className={c.name}>kristoffer petersen</div>
